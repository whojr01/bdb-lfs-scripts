...
#
# Script:
# Description: This script runs configure, builds, and installs thin-provisioning
# Distribution: thin-provisioning
# 

BUILD=thin-provisioning
STAGE=2
PASS=1
SCRIPT=$0
...

{
	time { \
		...
		./configure --prefix=/usr 	\
				--enable-testing > config.out 2>&1
		make > make.out 2>&1
		export CHEZSCHEMELIBDIRS=/usr/lib/thunderchez:.
