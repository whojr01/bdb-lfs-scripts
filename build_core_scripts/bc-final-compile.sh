...
#
# Script:
# Description: This script runs configure, builds, and installs bc
# Distribution: bc-1.07.1
# 
...
#
# This script will build, test, and install bc.
#
{
	time {
		../configure --prefix=/usr \
			...
			--infodir=/usr/share/info > config.out 2>&1 \
		&& make > make.out 2>&1 \
		&& echo "quit" | ./bc/bc -l ../Test/checklib.b > test.out 2>&1 \
