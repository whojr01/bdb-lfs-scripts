...
#
# Script:
# Description: This script runs configure, builds, and installs fontconfig
# Distribution: fontconfig-2.12.16
# 
...

{
	time { \
		./configure --prefix=/usr	\
			...
			--localstatedir=/var	\
			--disable-docs		\
			--docdir=/usr/share/doc/fontconfig-2.12.6 > config.out 2>&1 \
		&& make > make.out 2>&1 \
