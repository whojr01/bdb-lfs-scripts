...
#
# Script:
# Description: This script runs configure, builds, and installs mpfr
# Distribution: mpfr-4.0.0
# 
...
#
# This script builds, tests, and installs the math mpfr libraries.
#
{
	time {
		../configure --prefix=/usr	\
			--disable-static	\
			--enable-thread-safe	\
			--docdir=/usr/share/doc/mpfr-4.0.0 > config.out 2>&1	\
		&& make > make.out 2>&1 \
