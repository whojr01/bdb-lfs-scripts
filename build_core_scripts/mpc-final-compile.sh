...
#
# Script:
# Description: This script runs configure, builds, and installs mpc
# Distribution: mpc-1.1.0
# 
...
#
# This script builds, tests, and installs the math mpc libraries.
#
{
	time {
		../configure --prefix=/usr	\
			--disable-static	\
			--docdir=/usr/share/doc/mpc-1.1.0 > config.out 2>&1	\
		&& make > make.out 2>&1 \
