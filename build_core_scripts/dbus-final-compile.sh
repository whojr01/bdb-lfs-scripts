...
#
# Script:
# Description: This script runs configure, builds, and installs dbus
# Distribution: dbus-1.12.2
# 
...

{
	time { \
		../configure --prefix=/usr	\
			...
			--disable-xml-docs	\
			--docdir=/usr/share/doc/d-bus-1.12.2 \
			--with-console-auth-dir=/run/console > config.out 2>&1 \
		&& make > make.out 2>&1 \
