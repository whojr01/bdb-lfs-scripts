...
#
# Script:
# Description: This script runs configure, builds, and installs cmake
# Distribution: cmake-3.9.1
# 
...

{
	time { \
		./bootstrap --prefix=/usr \
			--system-libs	\
			--mandir=/share/man	\
			--docdir=/share/doc/cmake-3.9.1 > config.out 2>&1 \
		&& make > make.out 2>&1 \
		&& bin/ctest -j2 -O test.out 2>&1 \
