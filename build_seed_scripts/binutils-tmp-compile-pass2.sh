...
#
# Script:
# Description: This script runs configure, builds, and installs binutils-p2
...
# This script builds the temporary binutils package.
# Now we use our own tools to build binutils.
#
#
