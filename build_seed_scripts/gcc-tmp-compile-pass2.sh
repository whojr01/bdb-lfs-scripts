...
#
# Script:
# Description: This script runs configure, builds, and installs gcc-pass2
# Distribution: gcc-7.2.0
# 
...
# Configure and build statements to build the temporary gcc and g++.
#
#

{
	time { \
		...
		../configure				\
			...
			--disable-multilib		\
			--disable-bootstrap		\
			--disable-libgomp > config.out 2>&1 \
		&& make > make.out 2>&1			\
