...
#
# Script:
# Description: This script runs configure, builds, and installs libstdc++
# Distribution: libstdc++
# 
...
# Configure, build and install Libstdc++ its the standard C++ library.

{
	time {	\
		../libstdc++-v3/configure	\
			...
			--with-gxx-include-dir=/tools/x86_64-lfs-linux-gnu/include/c++/7.2.0 > config.out 2>&1 \
		&& make > make.out 2>&1 \
