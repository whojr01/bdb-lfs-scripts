...
#
# Script:
# Description: This script runs configure, builds, and installs ncurses
...
# Build ncurses package for terminal-independent handling of character screens

{
	time {	../configure	--prefix=/tools          \
			...
			--without-ada \
			--enable-widec \
			--enable-overwrite > config.out 2>&1 \
		&& make  > make.out 2>&1 \
